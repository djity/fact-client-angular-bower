angular.module('fact-client.directives', [
	'fact-client.directives.stream-list',
	'fact-client.directives.simple-slideshow',
]);
angular.module('fact-client.services', [
	'fact-client.services.dataset',
	'fact-client.services.feed',
	'fact-client.services.resource',
	'fact-client.services.room',
	'fact-client.services.stream'
]);
angular.module('fact-client.templates', []);
...
angular.module('fact-client.templates').run(['$templateCache', function($templateCache) {
    $templateCache.put('directives/fact-simple-slideshow/fact-simple-slideshow.html',
        "<!-- Alternative display of currentFact in 2 img tags. In order to trigger the ng-hide animation. -->\n<depiction ng-class=\"{rotate: rotate, fade: fade, slide: slide}\" ng-show=\"iter%2 == 1\">\n\t<img ng-src=\"{{iter%2 == 1 ? baseUrl + currentFact.depiction : baseUrl + previousFact.depiction}}\"/>\n</depiction>\n<depiction ng-class=\"{rotate: rotate, fade: fade, slide: slide}\" ng-show=\"iter%2 == 0\">\n\t<img ng-src=\"{{iter%2 == 0 ? baseUrl + currentFact.depiction : baseUrl + previousFact.depiction}}\"/>\n</depiction>\n\n<!-- Hidden image to preload in the browser cache -->\n<img ng-src=\"{{baseUrl + nextFact.depiction}}\" ng-show=\"false\"/>\n");
}]);
angular.module('fact-client.templates').run(['$templateCache', function($templateCache) {
    $templateCache.put('directives/fact-stream-list/fact-stream-list.html',
        "<md-list>\n\t<md-item ng-repeat=\"stream in streams\" ng-class=\"{active: currentStream == stream}\">\n\t\t<md-item-content ng-click=\"activeStream(stream)\" ink-ripple>\n\t\t\t<div class=\"md-tile-left\">\n\t\t\t\t<md-progress-circular ng-if=\"!stream.variantsLastFact['fast-low-verySmall']\" mode=\"indeterminate\"></md-progress-circular>\n\t\t\t\t<fact-simple-slideshow\n\t\t\t\t\tng-if=\"stream.variantsLastFact['fast-low-verySmall']\"\n\t\t\t\t\tfact=\"stream.variantsLastFact['fast-low-verySmall']\"\n\t\t\t\t\tpreload-delay=\"2000\"\n\t\t\t\t\tfade=\"true\"\n\t\t\t\t\trotate=\"true\"\n\t\t\t\t></fact-simple-slideshow>\n\t\t\t</div>\n\t\t\t<div class=\"md-tile-content\">\n\t\t\t\t<h3>{{stream.label}}</h3>\n\t\t\t\t<p>{{stream.description}}</p>\n\t\t\t</div>\n\t\t<md-item-content>\n\t</md-item>\n</md-list>\n");
}]);